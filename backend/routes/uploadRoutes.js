...
//     sharp(imagePath)
//   .resize(800, 600)  // Resize the original image to 800x600 pixels
//   .toFile(originalImagePath, (err, originalInfo) => {
//     if (err) {
//       console.log(err);
...
//     sharp(imagePath)
//       .resize(350, 250)  // Resize the thumbnail to 350x250 pixels
